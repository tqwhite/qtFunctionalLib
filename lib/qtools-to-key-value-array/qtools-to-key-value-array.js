...
var moduleFunction = function(args = {}) {
	...
	const qtToKeyValueArray = commonFunctions => {
		const methodName = 'qtToKeyValueArray';
		const description = `operand.${methodName} Takes an Object, Map or Set. Converts object or map into an array of {key:'keyName', value:'value'} pairs. A Set does not have a key property.`;
	...
	this.addToPrototype = addToPrototypeActual(
		qtToKeyValueArray(commonFunctions)
	);
