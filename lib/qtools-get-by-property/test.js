...
const moduleFunction = function({ logErrors = false, methodName='missing method name' }) {
	...
	thisStepResult = testArray.qtGetByProperty('a.color', 'red');
	...
	thisStepResult = testArray.qtGetByProperty('a.color', 'snake', 'pumpkins');
	...
	thisStepResult = testArray.qtGetByProperty('a.color', 'blue', 'pumpkins');
	...
	thisStepResult = testArray.qtGetByProperty('a.color', 'monkee');
